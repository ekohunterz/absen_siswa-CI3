                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <input type="text" class="form-control" maxlength="18" name="nip" id="nip" value="<?= $dataGuru->nip; ?>" onblur="nipAvail()" placeholder="NIP/NUPTK 18 digit">
                            </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <input type="text" class="form-control" name="nama" id="basic-icon-default-fullname" value="<?= $dataGuru->nama; ?>" placeholder="Nama Lengkap" aria-label="Nama Lengkap" aria-describedby="basic-icon-default-fullname2" />
                            </div>
                          </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <input type="text" class="form-control" name="username" value="<?= $dataGuru->username; ?>" id="username" onblur="userNameAvail()" placeholder="Username" aria-label="Username" aria-describedby="basic-icon-default-fullname2" />
                            </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <input type="text" id="basic-icon-default-phone" value="<?= $dataGuru->no_hp; ?>" class="form-control phone-mask" name="no_hp" placeholder="+628353353451" aria-label="+628353353451" aria-describedby="basic-icon-default-phone2" />
                            </div>
                          </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <input type="text" id="basic-icon-default-address" value="<?= $dataGuru->alamat; ?>" class="form-control" name="alamat" placeholder="Alamat Lengkap" aria-label="Alamat Lengkap" aria-describedby="basic-icon-default-address" />
                            </div>
                          </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-5">
                            <div class="input-group input-group-merge">
                              ...
                              <input type="text" id="basic-icon-default-born-city" value="<?= $dataGuru->tempat_lahir; ?>" class="form-control" name="tempat_lahir" placeholder="Tempat Lahir" aria-label="Tempat Lahir" aria-describedby="basic-icon-default-born-city" />
                            </div>
                          </div>
                          <div class="col-sm-5">
                            <div class="input-group input-group-merge">
                              <input type="date" id="basic-icon-default-born-city" class="form-control" value="<?= $dataGuru->tanggal_lahir; ?>" name="tanggal_lahir" placeholder="" aria-label="Tanggal Lahir" aria-describedby="basic-icon-default-born-city" />
                            </div>
                          </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="gender" value="Laki-laki" id="inlineRadio2" <?php echo ($dataGuru->jenis_kelamin == 'Laki-laki') ?  "checked" : "";  ?> />
                                <label class="form-check-label" for="inlineRadio2">Laki-Laki</label>
                              </div>
                              <div class="form-check form-check-inline ms-3">
                                <input class="form-check-input" type="radio" id="inlineRadio3" name="gender" value="Perempuan" <?php echo ($dataGuru->jenis_kelamin == 'Perempuan') ?  "checked" : "";  ?> />
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="status" value="2" id="inlineRadio2" <?php echo ($dataGuru->id_status == '2') ?  "checked" : "";  ?> />
                                <label class="form-check-label" for="inlineRadio2">PNS</label>
                              </div>
                              <div class="form-check form-check-inline ms-3">
                                <input class="form-check-input" type="radio" id="inlineRadio3" name="status" value="3" <?php echo ($dataGuru->id_status == '3') ?  "checked" : "";  ?> />
                        ...
                        <script>
                          ...
                          $(function() {
                            ...
                            $('#update').click(function() {
                              var data = new FormData($('#edit-guru')[0]);
                              $.ajax({
                                type: 'post',
