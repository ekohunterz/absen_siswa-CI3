...
<body class="hold-transition login-page">
  <div class="login-box" style="margin-top:5%;">
    ...
    <div class="login-box-body">
      ...
      <p class="login-box-msg h3">E-PRESENSI SMK NEGERI 4 KOTA SERANG</p>
      ...
      <hr class="my-4">
      <p>Download Aplikasi Presensi Khusus Siswa dibawah ini</p>
      <a class="btn btn-sm btn-block btn-primary mb-2" href="<?php echo base_url() . 'Auth/lakukan_download' ?>" style="background-color: #3b5998;" type="submit"><i class="fa fa-download"></i> Download Aplikasi Android</a>
    </div>
    <!-- /.login-box-body -->
