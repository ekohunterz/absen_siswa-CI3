...
class DataKehadiran extends CI_Controller
{
  public function __construct()
  {
    ...
    $this->load->model(array('user_m', 'kelas_m', 'absensi_m', 'siswa_m', 'guru_m', 'admin_m', 'mapel_m'));
  ...
  public function index()
  {
    ...
    $this->load->view('backend/layouts/wrapper', [
      'content' => 'backend/admin/dataHadir',
      'title' => 'Data Absensi',
      'profile' => $this->user_m->profile($id),
      'kelas' => $this->kelas_m->getKelas(),
      'jadwal' => $this->mapel_m->getMapelByKelas($id_kelas),
      'siswa' => $this->absensi_m->getSiswaAbsenAdmin($id_kelas, $tanggal, $mapel),
      'absensi' => $this->absensi_m->getRekapAdmin($id_kelas, $tanggal, $mapel),
      'userdata' => $id,
      'id_kelas' => $id_kelas
    ], FALSE);
  }
  ...
  public function export()
  {
    ...
    $sheet->setCellValue('E5', 'Jam Datang');
